...
final productsListProvider = NotifierProvider.autoDispose<_ProductsNotifier, _ProductsState>(
...
class _ProductsNotifier extends Notifier<_ProductsState> {
  ...
  @override
  _ProductsState build() {
    Future.microtask(() => load());
    return const _ProductsState();
  }
  ...
  Future<void> load({int page = 1}) async {
    ...
    try {
      final resp = await _dio.get(ApiConstants.productos, queryParameters: {
      ...
      state = _ProductsState(
        ...
        total:   (resp.data['meta']['total'] as num).toInt(),
        page:    page,
      );
    } catch (e) {
      state = _ProductsState(loading: false, error: e.toString());
    }
  }
        ...
        Container(
          ...
          child: Row(children: [
            ...
            _FilterChip(
              label: 'Stock Bajo',
              selected: false,
              onTap: () => notifier.toggleStockBajo(),
            ),
            const SizedBox(width: 12),
            ElevatedButton.icon(
                  ...
                  : state.items.isEmpty
                      ...
                      : ListView.separated(
                          ...
                          itemBuilder: (_, i) {
                            ...
                            final criticoColor = stock <= 0 ? AppColors.stockCritico
                                : stock <= stockMin ? AppColors.stockBajo : AppColors.stockNormal;
                            ...
                            return Container(
                              ...
                              child: Row(children: [
                                ...
                                Expanded(flex: 2, child: Text(
                                  p['categoria']?['nombre'] as String? ?? 'Sin categoría',
                                ...
                                SizedBox(
                                  ...
                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: criticoColor.withOpacity(0.1),
                                        borderRadius: BorderRadius.circular(20),
                                      ),
                                      child: Text(
                                        stock <= 0 ? 'Sin stock'
                                          : stock <= stockMin ? 'Stock bajo'
                                          : 'Normal',
                                ...
                                PopupMenuButton(
                                  ...
                                  onSelected: (v) async {
                                    ...
                                    if (v == 'delete') {
                                      ...
                                      if (confirmed == true) {
                                        try {
                                          await ref.read(dioProvider).delete('${ApiConstants.productos}/${p['id']}');
                                          notifier.load();
                                        } catch (_) {}
                                      }
                                    }
        ...
        if (state.total > 25)
          Container(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              Text('${state.total} productos en total',
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: _selected ? AppColors.primary50 : AppColors.surface,
          borderRadius: BorderRadius.circular(12),
          border: Border.all(color: _selected ? AppColors.primary : AppColors.border),
        ),
        child: Row(children: [
