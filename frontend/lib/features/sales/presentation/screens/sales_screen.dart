                ...
                return ListTile(
                  leading: Container(width: 42, height: 42,
                    decoration: BoxDecoration(
                      color: (isAnulada ? AppColors.error : AppColors.primary).withValues(alpha: 0.1),
                  ...
                  trailing: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: (isAnulada ? AppColors.error : AppColors.success).withValues(alpha: 0.1),
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ListView(controller: scrollCtrl, padding: const EdgeInsets.all(20), children: [
      Row(children: [
        ...
        if (estado == 'COMPLETADA') TextButton.icon(
          icon: const Icon(Icons.picture_as_pdf), label: const Text('Recibo'), onPressed: () {}),
      ]),
    ...
    final motivo = await showDialog<String>(context: context, builder: (_) => AlertDialog(
      ...
      actions: [
        ...
        ElevatedButton(onPressed: () => Navigator.pop(context, ctrl.text),
          style: ElevatedButton.styleFrom(backgroundColor: AppColors.error), child: const Text('Anular')),
      ]));
