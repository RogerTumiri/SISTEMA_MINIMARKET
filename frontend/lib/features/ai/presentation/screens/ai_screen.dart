...
class _AiScreenState extends ConsumerState<AiScreen> {
      ...
      appBar: AppBar(
        ...
        actions: [
          ElevatedButton.icon(
            ...
            label: const Text('Re-entrenar'),
            onPressed: _executing ? null : _ejecutar,
          ),
                        ...
                        return Card(child: Padding(padding: const EdgeInsets.all(16), child: Column(
                          ...
                          Row(children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(color: _confColor(conf).withOpacity(0.1), borderRadius: BorderRadius.circular(12)),
                          ...
                          Row(children: [
                            _predPill('7 días', preds['7_dias']),
                            const SizedBox(width: 8),
                            _predPill('14 días', preds['14_dias']),
                            const SizedBox(width: 8),
  ...
  Widget _emptyState(String title, String sub) => Center(child: Column(
  ...
  Color _confColor(double c) =>
    c >= 70 ? AppColors.success : c >= 40 ? AppColors.warning : AppColors.error;

  Future<void> _aprobar(String id, double cantidad) async {
    await ref.read(dioProvider).patch('http://localhost:8001/sugerencias/$id/aprobar',
        data: {'cantidad_aprobada': cantidad});
    _load();
  }
